  ...
  return (
    <div className={className}>
      ...
      <select
        ...
        className="mt-2 w-full rounded-xl border border-stone-300 bg-white px-3 py-2.5 text-sm text-stone-900 shadow-none focus:border-stone-900 focus:outline-none focus:ring-2 focus:ring-[#C79A5A]/40 disabled:cursor-not-allowed disabled:bg-stone-100"
      >
